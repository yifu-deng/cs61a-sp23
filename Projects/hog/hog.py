...
def square_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    # return num_rolls  # Remove this line once implemented.
    next_score = square_update(0, score, opponent_score)
    # print('Debug: ', next_score, score, opponent_score)
    if next_score - score >= threshold:
        return 0
    else:
        return num_rolls
    # END PROBLEM 11
